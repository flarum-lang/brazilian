...
Todas as alterações: [2.0.1...2.0.2](https://github.com/flarum-lang/brazilian/compare/2.0.1...2.0.2).
...
* Removidas traduções desatualizadas do Flarum/core (versão `2.0` ou superior é suportada).
* Traduções desatualizadas removidas (versão `2.0` ou superior é compatível).
...
**Traduções desatualizadas atualizadas e/ou removidas para extensões**:
...
**Suporte removido para extensões desatualizadas**:
...
Todas as alterações: [1.7.3...2.0.0](https://github.com/flarum-lang/brazilian/compare/1.7.3...2.0.0).
...
Todas as alterações: [1.7.0...1.7.1](https://github.com/flarum-lang/brazilian/compare/1.7.0...1.7.1).
...
Todas as alterações: [1.5.2...1.5.3](https://github.com/flarum-lang/brazilian/compare/1.5.2...1.5.3).
...
Todas as alterações: [1.5.1...1.5.2](https://github.com/flarum-lang/brazilian/compare/1.5.1...1.5.2).
